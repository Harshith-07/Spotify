...
function Search({ setView, setGlobalPlaylistId, setGlobalCurrentSongId, setGlobalIsTrackPlaying, setGlobalArtistId }) {
  ...
  return (
    <div className='flex-grow h-screen'>
      <header className='text-white sticky top-0 h-20 z-10 text-4xl flex items-center px-8'>
        ...
        <input value={inputVlaue} onChange={async (e) => {
          setInputVlaue(e.target.value)
          await updateSearchResults(e.target.value)
        }} ref={inputRef} placeholder='Search...' className='rounded-full bg-white w-96 pl-12 text-neutral-900 text-base py-2 font-normal outline-0' />
      </header>
